...
const Data = () => {
    return(
        <div className="home__data">
            <h1 className="home__title">Sai Meghana
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">  I'm very passionate and dedicated frontend developer based in India.</p>
           <a href="mailto:vemulasaimeghana@gmail.com" className="button button--flex"> Say Hello
           <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
